	...
	protected function register_tab_header_style_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .mf-category-tabs .tabs-header ul li .mf-icon' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .mf-category-tabs .tabs-header ul li a.active, {{WRAPPER}} .mf-category-tabs .tabs-header ul li a.active h2, {{WRAPPER}} .mf-category-tabs .tabs-header ul li a.active .mf-icon' => 'color: {{VALUE}};',
				],
			]
		);
