...
class Premium_Instagram_Feed extends Widget_Base {
    ...
    public function get_custom_help_url() {
		return 'https://youtu.be/6-pVl_ILXtQ';
	}
    ...
    protected function _register_controls() {
        ...
        $this->add_control('premium_instagram_feed_client_access_token',
                [
                    ...
                    'label_block'   => false,
                    'description'   => 'Get your access token from <a href="http://instagram.pixelunion.net/" target="_blank">here</a>',
                    ]
                );
        ...
        $this->add_control('premium_instagram_feed_tag_name',
            [
                'label'         => __('Filter by Tags', 'premium-addons-pro'),
                'type'          => Controls_Manager::TEXT,
    ...
    protected function render() {
        ...
        if( empty ( $settings['premium_instagram_feed_client_access_token'] ) ) : ?>
