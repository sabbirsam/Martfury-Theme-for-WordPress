! function (t, e, i, o, n) {
    t.fn.multiscroll = function (s) {
        ...
        }), s.navigation && (t('<div id="multiscroll-nav-' + s.id + '" class="multiscroll-nav"><ul class="premium-multiscroll-dot-list"></ul></div>').prependTo("#premium-multiscroll-" + s.id), (u = t("#multiscroll-nav-" + s.id)).css("color", s.navigationColor), u.addClass(s.navigationPosition).addClass(s.navigationVPosition)), t(".ms-left").css({
            width: s.leftWidth + "%"
        }), t(".ms-right").css({
