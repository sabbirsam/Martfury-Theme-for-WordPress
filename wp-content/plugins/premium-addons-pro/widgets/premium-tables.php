    ...
    $this->add_control('premium_table_body_repeater',
        ...
        $this->add_control('pagination',
            [
                ...
                'type' 			=> Controls_Manager::SWITCHER,
                'description'   => __('Please note that pagination works only on frontend', 'premium-addons-for-elementor')
            ]
        );
        ...
        $this->add_responsive_control('pagination_align',
            [
                'label'        => __( 'Pagination Alignment', 'premium-addons-for-elementor' ),
                'type'         => Controls_Manager::CHOOSE,
                'options'      => [
                    'flex-start'   => [
        ...
        $this->add_responsive_control('pagination_padding',
            [
                'label'         => __('Numbers Padding', 'premium-addons-for-elementor'),
                'type'          => Controls_Manager::DIMENSIONS,
                'size_units'    => [ 'px', 'em', '%' ],
                'selectors'     => [
