...
class Premium_Iconbox extends Widget_Base {
    ...
    <div class="premium-icon-box-container-out">
        <div class="premium-icon-box-container-in <?php echo esc_attr( $flex_pos ) . ' ' . esc_attr( $flex_ver_pos ); ?>" >
            ...
            <?php if( 'yes' === $settings['premium_icon_box_link_switcher']  && 'yes' !== $settings['box_link'] ) : ?>
        ...
        <?php if( 'yes' === $settings['box_link'] ) { ?>
            <a class="premium-icon-box-whole-link" href="<?php echo esc_url( $icon_box_url ); ?>" <?php if( ! empty( $settings['premium_icon_box_link']['is_external'] ) ) : ?> target="_blank" <?php endif; ?><?php if( ! empty( $settings['premium_icon_box_link']['nofollow'] ) ) : ?> rel="nofollow" <?php endif; ?>></a>
        <?php } ?>
    </div>
    <?php
    }
        ...
        <div class="premium-icon-box-container-out">
            <div class="premium-icon-box-container-in {{ flexPosition }} {{ flexVerPosition }} ">
                ...
                <div class="premium-icon-box-content-outer-wrap">
                    ...
                    <# if( 'yes' == settings.premium_icon_box_link_switcher && 'yes' !== settings.box_link ) { #>
