(function ($) {
    ...
    window.premiumHorizontalScroll = function ($elem, settings) {
        ...
        self.checkAnchors = function (link) {
        ...
        self.setScene = function () {
            ...
            horizontalSlide
                ...
                .to(
                    "#premium-hscroll-progress-line-" + id,
                    1, {
        ...
        self.onProgress = function () {
            var progressFillWidth = $elem
                .find(".premium-hscroll-progress-line")
                .outerWidth();
            ...
            $slides.each(function (index) {
                ...
                var scrollOffset = $slides.eq(index - 1)
                    .data("scroll-offset"),
                    scrollPosition = $(this)
                    .data("position");

                if (settings.opacity && 0 !== index) {
                    if (window.pageYOffset >= scrollOffset + elemWidth / 8) {
                        $(this)
                            .removeClass("premium-hscroll-hide");
                    } else {
                        $(this)
                            .addClass("premium-hscroll-hide");
                    }
                }
        ...
        self.scrollToSlide = function (slideIndex) {
            ...
            var spacerHeight = $("#premium-hscroll-spacer-" + id)
                .outerHeight();
