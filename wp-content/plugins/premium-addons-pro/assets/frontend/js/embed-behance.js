            ...
            function t() {
                0 == --r && (e(".eb-loadingicon").remove(), 1 == d ? function () {
                    function t() {
                        ...
                        e(".eb-container .box-inner-main").css("margin-top", t), e(".eb-desktop-info").css("height", "63px"), e(".eb-container .box-project aside .wrap-owners-outer").css("min-height", t)
                    }
        ...
        e("body").on("click", ".sidebar-mobile .bh-show", function () {
            function t(t) {
                if ("show" == t) {
                    ...
                    e(".sidebar-mobile .bh-show > .label").text("Hide Info"), e(".eb-container aside.sidebar-mobile").addClass("open"), e(".eb-container aside.sidebar-mobile .icon-chevron").html(C("chevronUp")), e(".eb-container aside.sidebar-mobile").animate({
                        height: i
                    }, n.animationDuration).css("border-radius", 15)
                } else "hide" == t && (e(".sidebar-mobile .bh-show > .label").text("Show Info"), e("aside.sidebar-mobile").removeClass("open"), e(".eb-container aside.sidebar-mobile .icon-chevron").html(C("chevronDown")), e(".eb-container aside.sidebar-mobile").animate({
                    height: 42
