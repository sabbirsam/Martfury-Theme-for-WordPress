...
class Module {
    ...
    public function __construct() {
        ...
        add_action( 'dokan_activated_module_product_subscription', array( self::class, 'activate' ) );
        add_action( 'dokan_deactivated_module_product_subscription', array( self::class, 'deactivate' ) );
